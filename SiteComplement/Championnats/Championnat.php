        ...
        options: {
            scales: {
                x: {
                    ...
                    ticks: {
                        color: '#fff', // Couleur blanche pour les valeurs de l'axe x
                        font: {
                    ...
                    grid: {
                        color: 'rgba(255, 255, 255, 0.2)', // Couleur blanche des lignes de la grille
                ...
                y: {
                    ...
                    ticks: {
                        color: '#fff', // Couleur blanche pour les valeurs de l'axe y
                        font: {
