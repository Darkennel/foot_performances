...
<head>
    ...
    <style>
        ...
        #suggestionsContainer {
            position: absolute;
            top: 100%;
            /* Position en dessous du champ de recherche */
            left: 0;
            width: 100%;
        }
    ...
    <script>
        $(document).ready(function() {
            ...
            function displaySuggestions(suggestions) {
                ...
                // Vérifie s'il y a des suggestions à afficher
                if (suggestions.length > 0) {
                    // Parcourt chaque suggestion
                    $.each(suggestions, function(index, suggestion) {
                        // Crée un élément de liste pour chaque suggestion
                        var listItem = $("<li>").text(suggestion);

                        // Ajoute un gestionnaire d'événement au clic de chaque élément de liste
                        listItem.on('click', function() {
                            console.log('Suggestion sélectionnée:', suggestion);
                            // Vous pouvez ajouter ici le code pour ce que vous souhaitez faire après la sélection d'une suggestion
                        });

                        // Ajoute l'élément de liste à la liste des suggestions
                    ...
                    // Si aucune suggestion n'est retournée, cache la liste des suggestions
