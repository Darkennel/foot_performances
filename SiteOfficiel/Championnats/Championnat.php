        ...
        function displayTopScorers(data) {
            ...
            if (data.length > 0) {
                $.each(data, function(index, player) {
                    var row = "<tr><td>" + (index + 1) + "</td><td><a href='/Site/biojoueur.php?id=" + player.id_nom + "' class='lienjoueur' style='color: blue; text-decoration: none;' alt='" + player.Nom + "'>" + player.Nom + "</a></td><td>" + player.Buts + "</td></tr>";
